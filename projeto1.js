...
console.log();
let resposta1 = prompt('Você criou aliados durante a sua jornada para te ajudar a derrotar os orcs? ');
while(resposta1 != 'sim' && resposta1 != 'nao'){
    console.log('Responda apenas sim ou nao!');
    resposta1 = prompt('Você criou aliados durante a sua jornada para te ajudar a derrotar os orcs? ');
    }if(resposta1 == 'sim'){
    i++;
}
console.log();
let resposta2 = prompt('Você esteve em algumas batalhas para aumentar os atributos do seu artefato para melhorar suas habilidades? ');
while(resposta2 != 'sim' && resposta2 != 'nao'){
    console.log('Responda apenas sim ou nao!');
    resposta2 = prompt('Você esteve em algumas batalhas para aumentar os atributos do seu artefato para melhorar suas habilidades? ');
    }if(resposta2 == 'sim'){
    i++;
}
console.log();
let resposta3 = prompt('Você encontrou a base orc e identificou as armadilhas mágicas e físicas ao seu redor? ');
while(resposta3 != 'sim' && resposta3 != 'nao'){
    console.log('Responda apenas sim ou nao!');
    resposta3 = prompt('Você encontrou a base orc e identificou as armadilhas mágicas e físicas ao seu redor? ');
    }if(resposta3 == 'sim'){
    i++;
}
console.log();
let resposta4 = prompt('Você enfrentou os orcs com os seus aliados e com a ajuda do seu dispositivo de habilidades? ');
while(resposta4 != 'sim' && resposta4 != 'nao'){
    console.log('Responda apenas sim ou nao!');
    resposta4 = prompt('Você enfrentou os orcs com os seus aliados e com a ajuda do seu dispositivo de habilidades? ');
    }if(resposta4 == 'sim'){
    i++;
}
console.log();
